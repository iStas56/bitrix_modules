# lenvendo.conversion - расчет конверсии сделок менеджеров

# lenvendo.declension - модуль для склонения имен(должностей, определение пола, перевод сумм в цифры, валюты, предлоги, окончания слов) при генерации документов в бизнес процессах(отпуск, премии и т.д.) битрикс24.
