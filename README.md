...
# lenvendo.declension модуль для генерации документов в бизнес процессах(отпуск, премии и т.д.) битрикс24. Склонения имен, должностей, определение пола, перевод сумм в цифры, валюты, предлоги, окончания
