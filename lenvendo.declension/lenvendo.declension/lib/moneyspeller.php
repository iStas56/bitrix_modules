...
use \Lenvendo\Declension\Traits\CurrenciesHelper;
use RuntimeException;

class MoneySpeller extends \Lenvendo\Declension\Abstracts\MoneySpeller
{
        ...
        switch ($format) {
            ...
            case static::DUPLICATION_FORMAT:
                ...
                $integer_spelled = CardinalNumeralGenerator::getCase(
                    $integer,
                    $case !== null ? $case : RussianCases::IMENIT,
